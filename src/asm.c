...
int print_disassembly(FILE *out, struct instruction *i, int flags)
{
    ...
    static const char *fmts[C_(1,1,1,1,1)+1] = {
      ...
      //[C_(1,0,0,0,0)] = "%1$c%2$c%3$c %4$s %5$c"                           "%10$c", // [Z] <- [           ]
        [C_(1,0,0,0,1)] = "%1$c%2$c%3$c %4$s %5$c"                   "0x%9$08x%10$c", // [Z] <- [         -0]
        [C_(1,0,0,1,0)] = "%1$c%2$c%3$c %4$s %5$c"            "%8$c"         "%10$c", // [Z] <- [    Y      ]
        [C_(1,0,0,1,1)] = "%1$c%2$c%3$c %4$s %5$c"            "%8$c + 0x%9$08x%10$c", // [Z] <- [    Y +  -0]
        [C_(1,0,1,0,0)] = "%1$c%2$c%3$c %4$s %5$c%6$c"                       "%10$c", // [Z] <- [X          ]
        [C_(1,0,1,0,1)] = "%1$c%2$c%3$c %4$s %5$c%6$c"            " + 0x%9$08x%10$c", // [Z] <- [X     +  -0]
        [C_(1,0,1,1,0)] = "%1$c%2$c%3$c %4$s %5$c%6$c %7$-2s ""%8$c"         "%10$c", // [Z] <- [X - Y      ]
        [C_(1,0,1,1,1)] = "%1$c%2$c%3$c %4$s %5$c%6$c %7$-2s ""%8$c + 0x%9$08x%10$c", // [Z] <- [X - Y +  -0]
