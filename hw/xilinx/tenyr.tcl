...
proc add_source_files {} {
   ...
   xfile add "ipcore_dir/tenyr_clk_S.xco"
...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "/mnt/kiri-kulp/Documents/Code/C/tenyr/hw/xilinx/Tenyr.ucf" -process "Back-annotate Pin Locations"
   project set "Use DSP Block" "Automax" -process "Synthesize - XST"
   project set "Keep Hierarchy" "Yes" -process "Synthesize - XST"
   project set "Verilog Include Directories" "/mnt/kiri-kulp/Documents/Code/C/tenyr/hw/verilog" -process "Synthesize - XST"
